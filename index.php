<?php
    ...
    function curl($url) {
        ...
        //Эта функция должна вызываться после инициализации сеанса и установки всех необходимых параметров. 
    ...
    if ($_GET['city']) {
        ...
        $urlContents = curl("http://api.openweathermap.org/data/2.5/weather?q=".$_GET['city']."&type=accurate&appid=758eb996d86d0e5e92ead4f71cf3764c");
